...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < N; i += 2) nums.add(i);
    ...
    for (Integer num : nums) bst.insert(num, num);
    ...
    for (int i = 0; i < N; i++) {
      ...
      if (floorKey == null) System.out.println("NULL");
      else System.out.println(floorKey);
      ...
      if (ceilKey == null) System.out.println("NULL");
      else System.out.println(ceilKey);
