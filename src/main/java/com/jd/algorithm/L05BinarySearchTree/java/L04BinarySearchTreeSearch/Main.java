package com.jd.algorithm.L05BinarySearchTree.java.L04BinarySearchTreeSearch;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    if (FileOperations.readFile(filename, words)) {
      ...
      // 输出圣经中god一词出现的频率
      if (bst.contain("god")) System.out.println("'god' : " + bst.search("god"));
      else System.out.println("No word 'god' in " + filename);
      ...
      // 输出圣经中god一词出现的频率
      if (sst.contain("god")) System.out.println("'god' : " + sst.search("god"));
      else System.out.println("No word 'god' in " + filename);
