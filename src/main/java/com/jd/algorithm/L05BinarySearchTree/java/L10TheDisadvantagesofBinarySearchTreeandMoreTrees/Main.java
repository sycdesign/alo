package com.jd.algorithm.L05BinarySearchTree.java.L10TheDisadvantagesofBinarySearchTreeandMoreTrees;
  ...
  public static void main(String[] args) {
    ...
    if (FileOperations.readFile(filename, words)) {
      ...
      for (String word : words) {
        ...
        if (res == null) bst.insert(word, new Integer(1));
        else bst.insert(word, res + 1);
      }

      // 我们查看unite一词的词频
      if (bst.contain("unite")) System.out.println("'unite' : " + bst.search("unite"));
      else System.out.println("No word 'unite' in " + filename);
      ...
      for (String word : words) {
        ...
        if (res == null) sst.insert(word, new Integer(1));
        else sst.insert(word, res + 1);
      }

      // 我们查看unite一词的词频
      if (sst.contain("unite")) System.out.println("'unite' : " + sst.search("unite"));
      else System.out.println("No word 'unite' in " + filename);
      ...
      for (String word : words) {
        ...
        if (res == null) bst2.insert(word, new Integer(1));
        else bst2.insert(word, res + 1);
      }

      // 我们查看unite一词的词频
      if (bst.contain("unite")) System.out.println("'unite' : " + bst2.search("unite"));
      else System.out.println("No word 'unite' in " + filename);
