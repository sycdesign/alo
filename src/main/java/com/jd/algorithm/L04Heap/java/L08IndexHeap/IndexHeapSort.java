package com.jd.algorithm.L04Heap.java.L08IndexHeap;
...
public class IndexHeapSort {
  ...
  public static void sort(Comparable[] arr) {
    ...
    for (int i = 0; i < n; i++) indexMaxHeap.insert(i, arr[i]);

    for (int i = n - 1; i >= 0; i--) arr[i] = indexMaxHeap.extractMax();
  }
  ...
  public static void main(String[] args) {
    ...
    SortTestHelper.testSort("com.jd.algorithm.L04Heap.java.L08IndexHeap.IndexHeapSort", arr);
