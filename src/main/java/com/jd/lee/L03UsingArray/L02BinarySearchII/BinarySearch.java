package com.jd.lee.L03UsingArray.L02BinarySearchII;
...
public class BinarySearch {
  ...
  public static int binarySearch(Comparable[] arr, int n, Comparable target) {
    ...
    while (l < r) { // 当 l == r 时, 区间[l...r)是一个无效区间
      ...
      if (target.compareTo(arr[mid]) > 0) l = mid + 1; // target在[mid+1...r)中; [l...mid]一定没有target
      else // target < arr[mid]
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < n; i++)
      if (i != binarySearch(data, n, i)) throw new IllegalStateException("find i failed!");
