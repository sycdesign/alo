package com.jd.structures.L06BinarySearchTree.L05SearchinBST;
...
public class Solution {
  ...
  public int uniqueMorseRepresentations(String[] words) {
    ...
    for (String word : words) {
      ...
      for (int i = 0; i < word.length(); i++) res.append(codes[word.charAt(i) - 'a']);

      if (!bst.contains(res.toString())) bst.add(res.toString());
    }
