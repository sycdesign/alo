...
public class LoopQueue<E> implements Queue<E> {
  ...
  public String toString() {
    ...
    for (int i = 0; i < size; i++) {
      ...
      if ((i + front + 1) % data.length != tail) res.append(", ");
    }
    res.append("] tail");
    return res.toString();
  }
  ...
  public static void main(String[] args) {
    ...
    com.jd.structures.L03StacksandQueues.L06LoopQueue.LoopQueue<Integer> queue =
        new com.jd.structures.L03StacksandQueues.L06LoopQueue.LoopQueue<>();
    for (int i = 0; i < 10; i++) {
      queue.enqueue(i);
