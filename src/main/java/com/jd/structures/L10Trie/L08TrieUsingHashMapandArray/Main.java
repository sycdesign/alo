package com.jd.structures.L10Trie.L08TrieUsingHashMapandArray;

// 07SetandMap.L01SetBasicsandBSTSet.BSTSet;
// 10Trie.L02TrieBasics.Trie;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    if (FileOperation.readFile("pride-and-prejudice.txt", words)
      ...
      for (String word : words) trie2.add(word);

      for (String word : words) trie2.contains(word);
      ...
      for (String word : words) trie3.add(word);

      for (String word : words) trie3.contains(word);
