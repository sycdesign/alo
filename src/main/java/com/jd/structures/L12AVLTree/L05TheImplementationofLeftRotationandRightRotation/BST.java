package com.jd.structures.L12AVLTree.L05TheImplementationofLeftRotationandRightRotation;
...
public class BST<K extends Comparable<K>, V> {
  ...
  public static void main(String[] args) {
    ...
    if (FileOperation.readFile("pride-and-prejudice.txt", words)) {
      ...
      com.jd.structures.L14HashTable.L05HashTableImplementation.BST<String, Integer> map =
          new com.jd.structures.L14HashTable.L05HashTableImplementation.BST<>();
